...
function generate(repo) {
  ...
  const files = [
    ...
    { name: 'filter-shadowrocket.conf', fmt: 'Shadowrocket', desc: 'Shadowrocket 完整配置 (精选3万高危域名)' },
    { name: 'filter-shadowrocket-rules.txt', fmt: 'Shadowrocket Rules', desc: 'Shadowrocket 纯规则 (精选3万高危域名)' },
